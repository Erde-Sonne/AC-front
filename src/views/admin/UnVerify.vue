    ...
    export default {
        ...
        methods: {
            handleReqUnVerifyUser() {
                const _this = this
                axios.get('http://192.168.1.136:8888/unverify').then( function(response) {
            ...
            handleDelete(index, row) {
                ...
                axios.post('http://192.168.1.136:8888/user/deleteUnVerifyUser', _this.deleteUser).then( function(response) {
