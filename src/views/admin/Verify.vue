...
<script>
    export default {
        ...
        methods: {
            handleReqVerifyUser() {
                const _this = this
                axios.get('http://192.168.1.136:8888/verify').then( function(response) {
            ...
            handleEdit(index, row) {
                ...
                // axios.post('http://192.168.1.136:8888/user/deleteUnVerifyUser', _this.editUser).then( function(response) {
                //     console.log("从未授权库中删除")
                // });
                // axios.post('http://192.168.1.136:8888/verify', row).then( function(response) {
                //     console.log("授权成功")
                // });
            ...
            pushEdit() {
                ...
                _this.switcher = '';
                _this.port = '';
                axios.post('http://192.168.1.136:8888/administrator/updateVerifyUser', _this.editForm).then( function(response) {
                    console.log("更改成功")
                });
            },
            handleReturn() {
